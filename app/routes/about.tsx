...
export function meta({}: Route.MetaArgs) {
  return [
    { title: 'About Us - Mascort | Women-Led Creative Studio from Pakistan' },
    {
      name: 'description',
      content:
        'Meet our talented team of women designers and animators from Pakistan. Learn about our mission to empower women in the creative industry while delivering premium graphics and animations.',
    },
    {
      name: 'keywords',
      content:
        'women empowerment, pakistan creative studio, female designers, women in tech, creative team, about mascort',
    },
    { property: 'og:title', content: 'About Mascort - Empowering Women Through Creative Excellence' },
    {
      property: 'og:description',
      content: "Discover our story, mission, and the incredible women behind Mascort's success",
    },
